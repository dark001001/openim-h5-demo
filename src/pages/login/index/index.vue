<template>
  <div class="page_container !bg-white px-10 text-[#171A1D] relative">
    <div class="text-3xl font-semibold my-[10vh]">欢迎使用66CHAT</div>
    ...
    <van-form @submit="onSubmit">
      ...
      <div class="mt-3">
        ...
        <div class="border-b border-[rgba(126,134,142,0.16)]">
          <van-field class="!py-1 !pl-0" clearable v-model="formData.password" name="password" :rules="[{ required: true, message: '请输入密码' }]" type="password" placeholder="请输入密码" />
        </div>
      </div>

      <div class="mt-20">
        <van-button :loading="loading" :disabled="!(formData.phoneNumber && formData.password)" block type="primary" native-type="submit"> 登录 </van-button>
      </div>
      ...
      <div class="flex items-center mt-2">
        ...
        <div class="text-xs text-[#b9babd] ml-1">我已阅读并同意：<span class="text-[#0089FF]">《服务协议》</span>，<span class="text-[#0089FF]">《隐私政策协议》</span></div>
      </div>
    </van-form>
